...
--
-- Host: localhost
-- Generation Time: Nov 09, 2023 at 02:04 PM
...
-- Database: `ffm`
--
CREATE DATABASE IF NOT EXISTS `ffm` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ffm`;
...
('rdpjt5awm7dcdhh6yez0qefhbe9r4c8x', 'eyJ1c2VyaWQiOjF9:1qvcwB:h5y03IaJwW5uoAd419onIQPnGITxcZ-6YCdjxeTy-as', '2023-11-08 12:24:39.631205'),
...
('yjbln6rt13jjg1fl73zo8eztgykgdmka', 'eyJ1c2VyaWQiOjJ9:1qvebi:Ubfte8gJJevKps2ZoApT9it3GTLKxFJg34-2dikaOw4', '2023-11-08 14:11:38.374394'),
...
(6, 'Feed Forward Neural Network (FFNN)', '45.63106796116505'),
(7, 'SVM', '49.029126213592235'),
(8, 'Logistic Regression', '48.05825242718447'),
(9, 'Gradient Boosting Classifier', '48.54368932038835'),
(10, 'KNeighborsClassifier', '47.57281553398058');
...
(10, 'Heavy Rain', '50.0'),
(11, 'Cyclone and Flood', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_flood_forecasting`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_flood_forecasting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `UEI` varchar(3000) NOT NULL,
  ...
  `Districts` varchar(3000) NOT NULL,
  `State` varchar(3000) NOT NULL,
  `Latitude` varchar(3000) NOT NULL,
  `Longitude` varchar(3000) NOT NULL,
  `Severity` varchar(3000) NOT NULL,
  `Area_Affected` varchar(3000) NOT NULL,
  `Human_fatality` varchar(3000) NOT NULL,
  `Human_injured` varchar(3000) NOT NULL,
  `Human_Displaced` varchar(3000) NOT NULL,
  `Animal_Fatality` varchar(3000) NOT NULL,
  `Description_of_Casualties_injured` varchar(3000) NOT NULL,
  `Extent_of_damage` varchar(3000) NOT NULL,
  `Event_Source` varchar(3000) NOT NULL,
  `Event_Souce_ID` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_predict_flood_forecasting`
--

INSERT INTO `remote_user_predict_flood_forecasting` (`id`, `UEI`, `Start_Date`, `End_Date`, `Duration`, `Location`, `Districts`, `State`, `Latitude`, `Longitude`, `Severity`, `Area_Affected`, `Human_fatality`, `Human_injured`, `Human_Displaced`, `Animal_Fatality`, `Description_of_Casualties_injured`, `Extent_of_damage`, `Event_Source`, `Event_Souce_ID`, `Prediction`) VALUES
(1, '198.105.244.11-10.42.0.42-80-45718-6', '06-01-22', '06-06-22', '151', 'NA', 'Barpeta, Dhemaji, Golpara', 'ASSAM', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'About 900 people of 135 villages affected..', 'IMD', 'NA', 'Cyclone and Flood'),
(2, '203.205.191.21-10.42.0.211-80-47110-6', '06-09-22', '17-06-22', 'Diffing the dates', 'NA', 'Baksa, Barpeta, Darrang, Dhemaji,Dibrugarh, Goalpara Jorhat,Kamrup, Kamrup (M), Lakhimpur,Morigaon, Nagaon, Nalbari,Sivsagar, Sonitpur, and Tinsukia', 'ASSAM', 'NA', 'NA', 'NA', 'NA', '3', 'NA', 'NA', 'NA', '3 persons died in Sonitpur & Baksa', 'NA', 'IMD', 'NA', 'Heavy Rain'),
(3, '10.42.0.211-10.42.0.1-62839-53-17', '19-08-22', '23-08-22', '4', 'NA', 'Barpeta, Bongaigaon, Chirang, Darrang, Dhemaji, Dhubri, Dibrugarh, Golaghat, Goalpara Jorhat, Kamrup, Kokrajhar, Lakhimpur, Morigaon, Nagaon, Nalbari, Sivsagar, Sonitpur, and Tinsukia ', 'ASSAM', 'NA', 'NA', 'NA', 'NA', '8', 'NA', 'NA', 'NA', '8 persons died', 'i) 5,76,537 population affected. ii) Extensive damage to 1200 villages reported. iii) Damage to cropland of area 55,553 hectares reported.', 'IMD', 'NA', 'Heavy Rain'),
(4, '10.42.0.42-72.30.2.182-42276-443-6', '05-10-22', '14-05-22', 'Diffing the dates', 'NA', 'Ernakulam, Idukkai, Kannur, Kasaragod, Kollam, Kozhikode, Mallapuram, Palakkad, Thrissur, Wayanad', 'KERALA', 'NA', 'NA', 'NA', 'NA', 'NA', '4', 'NA', 'NA', '4 persons injured', 'i) Damage to Agriculture crops Banana, Rubber crops & 500 acres of Paddy fields reported. ii) Damage to several houses reported. iii) Water logging in low lying areas. iv) Loss worth Rs.60,000/-. v) Well caved in. vi) A huge tree uprooted & fell across Kozhikode-Vythiri-Ooty State Highway causing traffic disruption', 'IMD', 'NA', 'Cyclone and Flood');
