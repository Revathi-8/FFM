...
urlpatterns = [
    ...
    url(r'^Predict_flood_forecasting_Detection/$', remoteuser.Predict_flood_forecasting_Detection, name="Predict_flood_forecasting_Detection"),
    ...
    url(r'^View_Prediction_Of_Flood_Forecasting_Detection_Ratio/$', serviceprovider.View_Prediction_Of_Flood_Forecasting_Detection_Ratio, name="View_Prediction_Of_Flood_Forecasting_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Flood_Forecasting_Detection/$', serviceprovider.View_Prediction_Of_Flood_Forecasting_Detection, name="View_Prediction_Of_Flood_Forecasting_Detection"),
